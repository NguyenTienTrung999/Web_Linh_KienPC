...
@section('title', 'Thêm Mã Khuyến Mãi Mới - TechFlow Admin')
...
<div class="flex items-center gap-4 mb-8">
    ...
    <div>
        <h2 class="text-slate-900 dark:text-white text-xl font-bold tracking-tight">Thêm mã khuyến mãi</h2>
        <p class="text-sm text-slate-500 dark:text-slate-400">Tạo mã giảm giá mới cho khách hàng</p>
    </div>
</div>
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="max-w-3xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" name="code" value="{{ old('code') }}" required class="w-full h-12 rounded-lg border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary uppercase px-4 @error('code') border-red-500 @enderror" placeholder="VD: TECHFLOW10">
                @error('code')
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="number" name="discount_value" value="{{ old('discount_value') }}" required min="0" class="w-full h-12 rounded-lg border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary px-4 @error('discount_value') border-red-500 @enderror" placeholder="VD: 50000 hoặc 10">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="number" name="min_order_value" value="{{ old('min_order_value', 0) }}" min="0" class="w-full h-12 rounded-lg border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary px-4 @error('min_order_value') border-red-500 @enderror" placeholder="VD: 100000">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" min="1" class="w-full h-12 rounded-lg border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary px-4 @error('usage_limit') border-red-500 @enderror" placeholder="VD: 100">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="datetime-local" name="valid_from" value="{{ old('valid_from') }}" class="w-full h-12 rounded-lg border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary px-4 @error('valid_from') border-red-500 @enderror">
                @error('valid_from')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="datetime-local" name="valid_to" value="{{ old('valid_to') }}" class="w-full h-12 rounded-lg border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary px-4 @error('valid_to') border-red-500 @enderror">
                @error('valid_to')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
